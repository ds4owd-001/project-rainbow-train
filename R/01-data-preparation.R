...
# R script to read an XLSX file and clean the data. The tidy data is then 
# saved as a CSV file.
...
data_day1_in <- read_xlsx(here::here("data/raw/Faecal sludge Analysis_05112023.xlsx"), 
                          sheet = 1,
                          range = "A2:C7")
...
write_csv(data_clean, "data/processed/faecal-sludge-analysis.csv")
